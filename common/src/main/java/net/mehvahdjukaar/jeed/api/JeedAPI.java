...
public class JeedAPI {
    ...
    /**
     * If regstering stuff for the inventory screen remember you need to register for both CreativeModeInventoryScreen and InventoryScreen
     */
     ...
     * Call encase your mod removes or alter the effects in that screen, and you don't want to register your own proper extension to replace it
     */
    @SuppressWarnings("all")
    public static void disableVanillaInventoryScreenExtension() {
        registerScreenExtension(CreativeModeInventoryScreen.class, IEffectScreenExtension.NO_OP);
        registerScreenExtension(InventoryScreen.class, IEffectScreenExtension.NO_OP);
    }
}
